...
#删除冲突插件
rm -rf $(find ./feeds/luci/ -type d -regex ".*\(argon\|design\|vlmcsd\).*")
rm -rf feeds/smpackage/{base-files,dnsmasq,firewall*,fullconenat,libnftnl,nftables,ppp,opkg,ucl,upx,vsftpd-alt,miniupnpd-iptables,wireless-regdb,openclash}
#修改默认主题
